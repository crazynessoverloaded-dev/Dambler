...
const ALL_GAMES = [
  ...
  { id: 'chuck-a-luck',     title: 'Chuck-a-Luck',       category: 'Dice Games',       image: '/chuck-a-lick gemini.png',       rtp: '97.0', featured: false },
  { id: 'andar-bahar',      title: 'Andar Bahar',        category: 'Card Games',       image: '/Andar Bahar gemini.png',        rtp: '97.0', featured: false },
  { id: 'pontoon',          title: 'Pontoon',            category: 'Card Games',       image: '/Pontoon gemini.png',            rtp: '97.5', featured: false },
  { id: 'caribbean-stud',   title: 'Caribbean Stud',     category: 'Card Games',       image: '/Caribbean stud gemini.png',     rtp: '97.2', featured: false },
  { id: 'casino-holdem',    title: "Casino Hold'em",     category: 'Card Games',       image: "/CASINO HOLD'EM gemini.png",     rtp: '97.0', featured: false },
  { id: 'lightning-dice',   title: 'Lightning Dice',     category: 'Dice Games',       image: '/lightning dice gemini.png',     rtp: '96.5', featured: false },
  { id: 'bingo',            title: 'Bingo',              category: 'Lottery Games',    image: '/bingo gemini.png',              rtp: '95.0', featured: false },
  { id: 'rps',              title: 'Rock Paper Scissors',category: 'Luck Games',       image: '/Rock paper sissors gemini.png', rtp: '97.0', featured: false },
  { id: 'dice-21',          title: 'Dice 21',            category: 'Dice Games',       image: '/Dice 21 gemini.png',            rtp: '97.0', featured: false },
  { id: 'dice-duel',        title: 'Dice Duel',          category: 'Dice Games',       image: '/dice duel gemini.png',          rtp: '97.0', featured: false },
  { id: 'hot-dice',         title: 'Hot Dice',           category: 'Dice Games',       image: '/hot dice gemini.png',           rtp: '96.5', featured: false },
  ...
  { id: 'bigsix',           title: 'Big Six',            category: 'Wheel Games',      image: '/Big six gemini.png',            rtp: '96.0', featured: false },
...
export default function Casino() {
  ...
  const sortGames = (games: typeof ALL_GAMES) =>
    [...games].sort((a, b) => {
      if (sort === 'popular') return (b.featured ? 1 : 0) - (a.featured ? 1 : 0) || a.title.localeCompare(b.title);
